...
ClapTrap::ClapTrap(void) : 
	...
	std::cout << CYAN << "\t< ClapTrap default constructor called >" << RESET << " (name: " << this->_name << ")" << std::endl;
}
...
ClapTrap::ClapTrap(std::string name) : 
	...
	std::cout << CYAN << "\t< ClapTrap NAME constructor called >" << RESET << " (name: " << name << ")" << std::endl;
}
