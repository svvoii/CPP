...
int main(void) {

	{
		...
		std::cout << MAGENTA << "Expected output:" << RESET << std::endl;
	...
	}
	{
		...
		std::cout << BLUE << "`bool aIsNotEqualz = (a != zero);`" << RESET << "( " << a << " != " << zero << " )" << std::endl;
